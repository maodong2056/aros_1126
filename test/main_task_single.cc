                    ...
                    if (ecoinstanceobject->maskdata.size() > 0)
                    {
                        for (size_t kk = 0; kk < ecoinstanceobject->maskdata.size(); kk++)
                        {
                            if (ecoinstanceobject->maskdata[kk].bistrue)
                            {
                                ...
                                if (ecoinstanceobject->maskdata[kk].label == EM_OUT_CRIMP_LINE)
                                {
                                    cv::circle(img_RGB, cv::Point2f(points.x, points.y), 10, vcolor[ecoinstanceobject->maskdata[kk].inlabel% 100 + 1], -1);
                                }
