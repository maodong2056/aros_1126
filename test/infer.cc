...
int main(int argc, char** argv)
{
    ...
    std::cout << "ir image read success" << std::endl;
    ...
    input_data.input_image->image_depth_data_addr = img_depth.data;
    input_data.input_image->image_depth_height    = img_depth.rows;
    input_data.input_image->image_depth_width     = img_depth.cols;

    input_data.input_image->image_ir_data_addr    = img_ir.data;
